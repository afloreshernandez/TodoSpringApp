...
//		.password(passwordEnconder().encode("p"))
//		.roles("USER","ADMIN");
//		
...
//		.roles("ADMIN");
	...
	// 1. Database 2. LDAP 3. Active Directory 4. SSO 5. SAML 6. OAUTH 7. JWT
		...
		auth.userDetailsService(new UserService()).passwordEncoder(passwordEnconder());
	//getting userService details
	...
	protected void configure(HttpSecurity http) throws Exception{
		...
		.antMatchers("/","/login","/webjars/**") //not loggedin anonymous users
		     .permitAll()
